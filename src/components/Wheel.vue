...
const slices = sliceOrder.map((label, idx) => {
  if (label === 'Crazy Time')
    return { label: 'Crazy Time', type: 'minigame', id: 1, shorterLabel: 'CT' }
  if (label === 'Pachinko')
    return { label: 'Pachinko', type: 'minigame', id: 2, shorterLabel: 'PK' }
  if (label === 'Cash Hunt')
    return { label: 'Cash Hunt', type: 'minigame', id: 3, shorterLabel: 'CH' }
  if (label === 'Coin Flip')
    return { label: 'Coin Flip', type: 'minigame', id: 4, shorterLabel: 'CF' }
